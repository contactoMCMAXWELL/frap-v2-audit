...
import { formatDeviceDateTime, localIsoNow } from "../utils/datetime";
    ...
    <div style={{ padding: 16, maxWidth: 1040, margin: "0 auto" }}>
      ...
      <div style={{ marginTop: 14, border: "1px solid var(--border, #E5E7EB)", borderRadius: 16, padding: 12 }}>
        ...
        <div style={{ marginTop: 8, display: "flex", gap: 8, flexWrap: "wrap" }}>
          ...
          {pdfOpenedAt ? <Badge>pdf_opened: {formatDeviceDateTime(pdfOpenedAt)}</Badge> : <Badge>pdf_opened: —</Badge>}
                  ...
                  {events
                    ...
                    .map((e) => (
                      <div key={e.id} style={{ border: "1px solid var(--border, #E5E7EB)", borderRadius: 12, padding: 10 }}>
                        <div style={{ fontSize: 12, color: "var(--muted, #6b7280)" }}>{formatDeviceDateTime(e.ts)}</div>
                        <div style={{ fontWeight: 900 }}>
