...
# Full companies router V2
try:
    from app.api.companies import router as companies_router  # type: ignore
except Exception:  # pragma: no cover
...
# Full companies API under /api/companies
if companies_router is not None:
